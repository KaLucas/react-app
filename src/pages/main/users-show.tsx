...
import { CancelPresentationIcon, Report } from '@utils/icons';
      ...
      <Container sx={{ py: 6 }}>
        ...
        {isUsersError && (
          <Stack spacing={1} alignItems="center">
            ...
            <Typography sx={{ fontSize: '20px' }}>Erro ao carregar usuários</Typography>
          </Stack>
        )}
        {!isFetchingUsers &&
          !isUsersError &&
          (usersData?.data.length ? (
            ...
            <Stack spacing={1} alignItems="center">
              ...
              <Typography sx={{ fontSize: '20px' }}>Não há usuários cadastrados</Typography>
            </Stack>
          ))}
      </Container>
    </Box>
